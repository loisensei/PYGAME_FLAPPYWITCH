...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('Items/message.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('Items/base.png').convert_alpha()
    GAME_SPRITES['pipe'] =(pygame.transform.rotate(pygame.image.load( PIPE).convert_alpha(), 180), 
    pygame.image.load(PIPE).convert_alpha()
    )

    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('audios/die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('audios/hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('audios/point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('audios/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('audios/wing.wav')
