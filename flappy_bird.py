...
timer_draw = pygame.USEREVENT + 1


def init():
    # khởi tạo timer và list thunder
    pygame.time.set_timer(timer_draw, 3000)
    pygame.time.set_timer(timer_thunder, 8000)
    thunder5 = pygame.image.load('items/thunder5.png').convert_alpha()
    thunder2 = pygame.image.load('items/thunder2.png').convert_alpha()
    thunder1 = pygame.image.load('items/thunder1.png').convert_alpha()
    thunder6 = pygame.image.load('items/thunder6.png').convert_alpha()
    thunder7 = pygame.image.load('items/thunder7.png').convert_alpha()
    list_thunder.append(pygame.transform.scale(thunder2, (300, 300)))
    list_thunder.append(pygame.transform.scale(thunder1, (300, 372)))
    list_thunder.append(pygame.transform.scale(thunder5, (300, 300)))
    list_thunder.append(pygame.transform.scale(thunder6, (300, 300)))
    list_thunder.append(pygame.transform.scale(thunder7, (300, 300)))
